...
public class MissingActivities extends AppCompatActivity {
    ListView lvMissingActs;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_missing_activities);
        ...
        lvMissingActs = findViewById(R.id.lvMissingActs);

        RequestQueue queue = Volley.newRequestQueue(this);
        StringRequest request = new StringRequest(
                Request.Method.POST,
                "http://dominiclass.pythonanywhere.com/course/getMissingActivities",
                response -> {
                    try {
                        JSONObject jsonResponse = new JSONObject(response);
                        JSONArray courseArray = jsonResponse.getJSONArray("missing_activities");
                        ...
                        lvMissingActs.setAdapter(adapter);
